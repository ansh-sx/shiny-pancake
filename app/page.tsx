...
export default function Home() {
  ...
  useEffect(() => {
    // After initial profile animation, start showing content
    const timer = setTimeout(() => {
      setLoading(false)

      // Start showing content after profile animation completes
      const contentTimer = setTimeout(() => {
        setShowContent(true)
      }, 500)

      return () => clearTimeout(contentTimer)
    }, 3000) // Match this with the duration of the profile animation
